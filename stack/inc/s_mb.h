...
typedef struct
{
  MB_RS485module_t *RS485module;    //CAN module objects 		
  //MotorBox_t *MotorBoxModule;  			//motorbox module object
}MB_t; 
...
#if 0    
void vMBPortTimersDelay(uint16_t MB_ASCII_TIMEOUT_WAIT_BEFORE_SEND_MS);
#endif
